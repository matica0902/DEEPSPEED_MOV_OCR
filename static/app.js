        ...
        try {
            ...
            if (processData.success) {
                ...
                if (currentTaskId && selectedFile && selectedFile.type === 'application/pdf') {
                    ...
                    console.log(`✅ PDF前處理完成，共 ${preprocessResults.length} 頁，可以返回OCR Tab`);
                    ...
                    console.log(`✅ 已設置 processedPdfThumbnails，共 ${processedPdfThumbnails.length} 頁:`, processedPdfThumbnails.map(item => `頁${item.page}`).join(', '));
                }
            } else {
